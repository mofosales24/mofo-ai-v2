...
export interface User {
  ...
  role: 'admin' | 'user'; status: 'active' | 'suspended'; createdAt: string;
}
...
export interface LeadMagnet { title: string; table: { headers: string[]; rows: string[][]; }; sections: { title: string; items: string[]; }[]; checklist: string[]; }

export interface ContentPlan { selectedTopic: string; script: ContentScript; thread: ContentThread; leadMagnet: LeadMagnet; }
