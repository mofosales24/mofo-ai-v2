...
export interface Brand { id: string; userId: string; mode: BrandMode; data: BrandData; bio?: GeneratedBio; plan?: any; topics?: string[]; createdAt: string; updatedAt: string; }
